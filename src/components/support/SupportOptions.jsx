  ...
  return (
    ...
    <div className="text-center lg:text-left">
      ...
      <p className="mt-4 max-w-2xl">
        Got a question? Need a hand? Our support team is ready to make your Boitr experience smooth and stress-free.
      </p>
    </div>
    ...
    <div  className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {supportOptions.map((option, index) => (
        <div
          ...
          p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300`}
        >
          {/* Icon */}
          ...
          <button
            className={`mt-auto  px-4 py-2 text-white bg-[#2c1662] hover:bg-[#2c136f] 
            rounded-full transition-all duration-300 ${option.buttonColor}`}
          >
            {option.buttonLabel} →
          </button>
        </div>
